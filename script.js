...
const tools = [
  ...
  },
  {
    ...
    tags: ["Design", "Plan", "System Design"],
    status: "live",
    link: "./SystemDesign/index.html",
    groupname: ["Coder Tools"],
  },
  {
    icon: "fas fa-edit",
  ...
  },
  {
    ...
    status: "live",
    link: "./pointsNoteDowner/index.html",
    groupname: ["Writing Tools"],
  },
  {
    icon: "fas fa-star",
    ...
    status: "live",
    link: "./CSVMAKER/index.html",
    groupname: ["Writing Tools"],
  },
  {
    icon: "fas fa-star",
    title: "Theory Notes Writer",
    description: "Writing Notes for Theory. Advanced preparation tool ",
  ...
  },
  {
    ...
    tags: ["Remainder", "Task"],
    status: "live",
    link: "./remainderTasks/index.html",
